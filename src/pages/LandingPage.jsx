...
function LandingPage() {
    return (
        ...
        <div className="container-fluid d-flex justify-content-evenly border border-2 p-5">
               <div className="content" style={{width:"600px"}}>
                    ...
                    <h6 className='d-block '>Plays everything : </h6><span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae corrupti esse alias ut rerum dolorum deserunt laborum, officia nobis eligendi </span>
                    <h6 className='d-block'>Plays everything : </h6><span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae corrupti esse alias ut rerum dolorum deserunt laborum, officia nobis eligendi </span>
                    <h6 className='d-block'>Plays everything : </h6><span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae corrupti esse alias ut rerum dolorum deserunt laborum, officia nobis eligendi </span>
               </div>
               <div className="video">
                    <iframe width="689" height="387" src="https://www.youtube.com/embed/bJ-3kld5lZk" title="【GMV】Alan Walker Style - Coming Home (Animation Video)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
               </div>
        </div>
        </>
    )
